				...
				<div
					...
					<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>"
								...
								if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
									...
									<tr class="c-cart__shop-tr <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
										...
										<td class="c-cart__shop-td c-cart__shop-td--product-thumbnail">
											...
											<?php
											$thumbnail = apply_filters( 'woocommerce_cart_item_thumbnail', $_product->get_image( ideapark_mod( 'grid_image_fit' ) == 'cover' ? 'woocommerce_gallery_thumbnail' : 'medium', [ 'class' => 'c-cart__thumbnail-thumb c-cart__thumbnail-thumb--' . ideapark_mod( 'grid_image_fit' ) ] ), $cart_item, $cart_item_key );
						...
						<span class="c-cart__shop-update">
							<input type="submit"
								   class="c-button c-button--outline c-cart__shop-update-button<?php if ( ideapark_mod( 'cart_auto_update' ) ) { ?> c-cart__shop-update-button--auto<?php } ?> button"
								   name="update_cart"
