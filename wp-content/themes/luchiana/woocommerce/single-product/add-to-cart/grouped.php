...
<form class="cart grouped_form"
	...
	<?php if ( $quantites_required && $show_add_to_cart_button ) : ?>
		...
		<div class="buttons">
			<button type="submit"
					class="single_add_to_cart_button button alt <?php ideapark_class(ideapark_mod( 'buy_now' ) && ideapark_woocommerce_ajax_on() , 'with-buy-now', '' ); ?>"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
		</div>
