	...
	<div class="c-product-list-widget__wrap">
		<div class="c-product-list-widget__thumb-col">
			<a href="<?php echo esc_url( $product->get_permalink() ); ?>">
				<?php echo ideapark_wrap( $product->
				get_image( ideapark_mod( 'grid_image_fit' ) == 'cover' ? 'woocommerce_gallery_thumbnail' : 'medium', [ 'class' => 'c-product-list-widget__thumb c-product-list-widget__thumb--' . ideapark_mod( 'grid_image_fit' ) ] ) ); ?>
			</a>
		</div>
