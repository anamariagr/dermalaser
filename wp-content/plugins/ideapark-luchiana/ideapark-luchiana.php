...
define( 'IDEAPARK_LUCHIANA_FUNC_VERSION', '5.2' );
	...
	function ideapark_plugin_custom_meta_boxes( $meta_boxes ) {
		...
		$meta_boxes[] = [
			...
			'fields'     => [
				...
				[
					'name' => '',
					'desc' => __( 'Video (mp4, m4v, webm, ogv, flv) playback in the grid.', 'ideapark-luchiana' ),
	...
	function ideapark_admin_enqueue_scripts( $hook ) {
		if (
			...
			if ( is_object( $screen ) && $screen->post_type == 'post' ) {
				...
				wp_localize_script( 'ideapark-luchiana-post-format', 'ideapark_post_format_vars', [
...
add_shortcode( 'ip-post-share', function ( $atts ) {
	...
	$share_links = [
		'facebook'  => '<a class="c-post-share__link" target="_blank" href="//www.facebook.com/sharer.php?u=' . $esc_permalink . '" title="' . esc_html__( 'Share on Facebook', 'ideapark-luchiana' ) . '"><i class="ip-facebook c-post-share__icon c-post-share__icon--facebook"></i></a>',
		'twitter'   => '<a class="c-post-share__link" target="_blank" href="//twitter.com/share?url=' . $esc_permalink . '" title="' . esc_html__( 'Share on Twitter', 'ideapark-luchiana' ) . '"><i class="ip-twitter c-post-share__icon c-post-share__icon--twitter"></i></a>',
		'pinterest' => '<a class="c-post-share__link" target="_blank" href="//pinterest.com/pin/create/button/?url=' . $esc_permalink . ( $product_image ? '&amp;media=' . esc_url( $product_image[0] ) : '' ) . '&amp;description=' . urlencode( get_the_title() ) . '" title="' . esc_html__( 'Pin on Pinterest', 'ideapark-luchiana' ) . '"><i class="ip-pinterest c-post-share__icon c-post-share__icon--pinterest"></i></a>',
		'linkedin'  => '<a class="c-post-share__link" target="_blank" href="//www.linkedin.com/sharing/share-offsite/?url=' . $esc_permalink . '" title="' . esc_html__( 'Share on LinkedIn', 'ideapark-luchiana' ) . '"><i class="ip-linkedin c-post-share__icon c-post-share__icon--linkedin"></i></a>',
		'whatsapp'  => '<a class="c-post-share__link" target="_blank" href="//wa.me/?text=' . $esc_permalink . '" title="' . esc_html__( 'Share on Whatsapp', 'ideapark-luchiana' ) . '"><i class="ip-whatsapp c-post-share__icon c-post-share__icon--whatsapp"></i></a>',
		'telegram'  => '<a class="c-post-share__link" target="_blank" href="//telegram.me/share/url?url=' . $esc_permalink . '" title="' . esc_html__( 'Share on Telegram', 'ideapark-luchiana' ) . '"><i class="ip-telegram c-post-share__icon c-post-share__icon--telegram"></i></a>',
	];
