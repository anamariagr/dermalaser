					...
					switch ( $type ) {
						case 'color':
							...
							if ( $color && $color_secondary ) {
								$swatches = sprintf( '<span class="c-ip-attribute-filter__sw c-ip-attribute-filter__sw--color" style="background: linear-gradient(%3$s, %1$s 0%%, %1$s 50%%, %2$s 50%%, %2$s 100%%);"></span>',esc_attr( $color_secondary ), esc_attr( $color ), apply_filters( 'woo_variation_swatches_dual_color_gradient_angle', '-45deg' ) );
							} else {
